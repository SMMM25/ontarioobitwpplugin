        ...
        <div class="wrap" id="ontario-reset-rescan-wrap">
            ...
            <div id="rescan-only-panel" style="max-width:800px;">
                ...
                <div class="card" style="margin-top:15px;">
                    ...
                    <p><?php esc_html_e( 'Manually process pending obituaries through the Groq AI pipeline. Each batch extracts structured data (dates, age, location) and rewrites up to 3 obituaries (~60 seconds). The button auto-continues until all records are processed. Records are published after successful extraction + validation. Also runs automatically every 5 minutes via server cron.', 'ontario-obituaries' ); ?></p>
                    <?php
